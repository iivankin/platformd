...
export const auditActionOptions = [
  ...
  ["github_app.configure", "GitHub App configured"],
  ...
  ["registry.cleanup", "Unused registry images cleaned up"],
  ["registry.credential.create", "Registry credential created"],
  ["registry.credential.delete", "Registry credential deleted"],
  ["registry.hostname.clear", "Registry hostname cleared"],
  ["registry.hostname.set", "Registry hostname changed"],
  ["registry.manifest.delete", "Registry image deleted"],
  ["registry.repository.create", "Registry repository created"],
  ["registry.repository.delete", "Registry repository deleted"],
  ["registry.repository.public_pull.set", "Public image pulls changed"],
  ["registry.restore", "Registry repository restored"],
  ["registry.tag.delete", "Registry tag deleted"],
