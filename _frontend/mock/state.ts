...
const service: Service = {
  ...
  source: {
    autoUpdate: true,
    image: { reference: "ghcr.io/storefront/api:stable" },
    type: "public_image",
  },
  updatedAt: now - 90_000,
  volumeMounts: [],
...
const makeEmptyState = (scenario: MockScenario): MockState => ({
  ...
  diskPressure: {
    ...
    components: [
      ...
      { bytes: 8_589_934_592, id: "images" },
      { bytes: 6_442_450_944, id: "object_storage" },
      { bytes: 3_221_225_472, id: "telemetry" },
      { bytes: 1_610_612_736, id: "recordings", parent: "telemetry" },
  ...
  state.deployments[service.id] = [
    ...
    },
    {
      ...
      snapshot: {
        ...
        source: {
          autoUpdate: true,
          image: { reference: "ghcr.io/storefront/api:candidate" },
          type: "public_image",
        },
        volumeMounts: [],
      },
    ...
    },
    {
      ...
      snapshot: {
        ...
        source: {
          autoUpdate: true,
          image: { reference: "ghcr.io/storefront/api:previous" },
          type: "public_image",
        },
        volumeMounts: [],
      },
