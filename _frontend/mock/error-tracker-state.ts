...
export interface ErrorTrackerMockState {
  apiTokens: ApiToken[];
  apps: App[];
...
const appId = "k9n2p4r7t5v8x3z6b1d4f7h2";
const projectId = "1";
const issueId =
...
export const createErrorTrackerMockState = (): ErrorTrackerMockState => ({
  apiTokens: [
    {
      appId,
      createdAt: "2026-08-09T08:01:41Z",
      id: "token_release_dashboard",
  ...
  apps: [
    {
      ...
      dsn: `http://be1ca1a7343244188fae4c8a4c53d55e@127.0.0.1:3101/${projectId}`,
      id: appId,
      name: "Storefront Web",
      projectId,
      publicKey: "be1ca1a7343244188fae4c8a4c53d55e",
      slug: "storefront-web",
      updatedAt: "2026-08-09T08:01:41Z",
      webhooks: [
        {
          createdAt: "2026-08-09T08:01:41Z",
          enabled: true,
    ...
    },
    {
      ...
      dsn: "http://349c97f7b3844d0995af99a2d3809d4a@127.0.0.1:3101/2",
      id: "q4s7u2w8y1a6c9e3g5j7l2n8",
      name: "Mobile API",
      projectId: "2",
      publicKey: "349c97f7b3844d0995af99a2d3809d4a",
      slug: "mobile-api",
