...
func TestProtectAdminRejectsMissingTokenCSRFAndHostMismatch(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "public webhook bypasses this middleware", request: adminRequest(http.MethodPost, "/public/api/v1/integrations/github/webhook"), status: http.StatusForbidden},
