...
func TestSecurityHeaders(t *testing.T) {
	...
	if got := response.Header().Get("Content-Security-Policy"); !strings.Contains(got, "frame-ancestors 'none'") || !strings.Contains(got, "img-src 'self' data: https:") || strings.Contains(got, "unsafe-inline") {
