...
func (stack *runtimeStack) ErrorTrackerGateway(projectID string) (netip.Addr, error) {
	stack.mu.Lock()
...
func (stack *runtimeStack) PublishErrorTracker(projectID, hostname string) error {
	stack.mu.Lock()
	...
	project.ErrorTrackerEnabled = true
