...
// libpod.
func newConmonOCIRuntime(name string, paths []string, conmonPath string, runtimeFlags []string, runtimeCfg *config.Config, conmonCleanup bool) (OCIRuntime, error) {
	if name == "" {
	...
	runtime.conmonCleanup = conmonCleanup
