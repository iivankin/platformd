...
type ContainerMiscConfig struct {
	...
	// LogRotate asks conmon to rotate rather than truncate a full log file.
	LogRotate bool `json:"logRotate"`
	// LogMaxFiles is the total number of active and rotated log files retained by conmon.
	LogMaxFiles uint `json:"logMaxFiles"`
